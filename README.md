...
## Installation
The latest release (2.11.1) can be installed via:

```
bash -c "`curl -sL https://raw.githubusercontent.com/michaelsauter/crane/v2.11.1/download.sh`" && sudo mv crane /usr/local/bin/crane
```
...
[changelog](https://github.com/michaelsauter/crane/blob/v2.11.1/CHANGELOG.md)
when upgrading.
...
See the [Docker documentation](https://docs.docker.com/engine/reference/commandline/docker/) for more details about the parameters.
