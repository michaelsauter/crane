...
## Installation
The latest release (2.8.2) can be installed via:

```
bash -c "`curl -sL https://raw.githubusercontent.com/michaelsauter/crane/v2.8.2/download.sh`" && sudo mv crane /usr/local/bin/crane
```
...
[changelog](https://github.com/michaelsauter/crane/blob/v2.8.2/CHANGELOG.md)
when upgrading.
